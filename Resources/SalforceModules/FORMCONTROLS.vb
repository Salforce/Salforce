...
Module FORMCONTROLS
    ...
    Function LoadEmployeeGrid()
        ...
        With frmEmployeeProfileBackup.DataGridView1.SelectedCells
            ...
            EmployeeStructure = EmployeeData.Retrieve_Employee_Data(EMPCOMP, EMPID)
            With frmEmployeeProfileBackup
                .txtCompanyNr.Text = EmployeeStructure.CompanyNr
                .cmbSelectCompany.Text = EmployeeStructure.CompanyNr
                .txtEmployeeNr.Text = EmployeeStructure.EmployeeNr
                .txtEmployeeFirstName.Text = EmployeeStructure.EmployeeFirstName
                .txtemployeeLastName.Text = EmployeeStructure.EmployeeLastName
                .txtemployeeAddress.Text = EmployeeStructure.EmployeeAddress
                .txtDepartmentNr.Text = EmployeeStructure.EmployeeDepartment
                .txtDateBegin.Text = EmployeeStructure.EmployeeStartDate
                .txtDateEnd.Text = EmployeeStructure.EmployeeEndDate
                .txtBirthdate.Text = EmployeeStructure.EmployeeBirthdate
                .txtEmployeeCedulaNr.Text = EmployeeStructure.EmployeeCedulaNr
                .txtEmployeeStatus.Text = EmployeeStructure.EmployeeStatus
                .txtEmployeeEmail1.Text = EmployeeStructure.EmployeeEmail1
                .txtEmployeeEmail2.Text = EmployeeStructure.EmployeeEmail2
                .txtEmployeefunction.Text = EmployeeStructure.EmployeePosition
                .txtEmployeeHomePhone.Text = EmployeeStructure.EmployeeHomePhone
                .txtEmployeeMobile.Text = EmployeeStructure.EmployeeCellNr
                .cmbIsland.Text = EmployeeStructure.EmployeeIsland
                .txtEmployeeMAN.Checked = IIf(EmployeeStructure.EmployeeSex = "M", 1, 0)
                .txtEmployeeVRW.Checked = IIf(EmployeeStructure.EmployeeSex = "V", 1, 0)
                .txtEmployeePicture.Text = EmployeeStructure.EmployeePicture

                If ImageExist(.txtEmployeePicture.Text) Then
                    .EmpPictBox.Load(Application.StartupPath & "\EMPPICTS\" & .txtEmployeePicture.Text & ".jpg")
                Else
                    .EmpPictBox.Load(Application.StartupPath & "\EMPPICTS\nopict.jpg")
                End If
